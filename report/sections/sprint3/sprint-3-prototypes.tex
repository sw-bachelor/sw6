...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{sprint3-prototypes/copy_weekplan_confirmed.png} 
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{sprint3-prototypes/pictogram_add_camera.png}
