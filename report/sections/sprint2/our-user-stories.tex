...
\begin{lstlisting}[caption={The week plan BLoC},label={lst:weekplanbloc},language={[Sharp]C}]
...
\begin{lstlisting}[caption={Setting up the screen},label={lst:screensetup},language={[Sharp]C}]
...
\begin{lstlisting}[caption={Building the structure},label={lst:screenstructure},language={[Sharp]C}]
  @override
...
\begin{lstlisting}[caption={Building the week},label={lst:screenbuildweek},language={[Sharp]C}]
...
\begin{lstlisting}[caption={Building days and activities},label={lst:screendaysandactivities},language={[Sharp]C}]
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.6\textwidth]{ugeplan_view_implemented.PNG}
