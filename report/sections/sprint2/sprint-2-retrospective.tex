...
The third idea to be implemented was to modify the lint analysis of pull request to give errors rather than warning when the documentation of public members was not acceptable.
...
As such, we will not be making any major changes for the next sprint of the GIRAF project.