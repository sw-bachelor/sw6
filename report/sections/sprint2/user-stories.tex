...
Unlike in sprint 1, where we only provided the teams with the user story, a short description and prototypes to show how the task should be done, we added technical specifications to the user stories, to give the development teams a better understanding of what was expected of them.
We chose to do this because of the feedback received during the retrospective for the previous sprint.
...
In this sprint, 16 of the 29 user stories were assigned to groups.
These user stories can be seen on \autoref{table:user-stories-sprint-2}.
