...
This meant that the PO group would not be able to send a representative to each group during planning, but the different groups could approach the PO group for discussion and confirmation of stories when ready.
