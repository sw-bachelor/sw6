...
Combining the user stories in \autoref{before-sprint-1} with the most essential key points of the interview featuring Emil discussed in \autoref{interview-with-emil} we produced an initial product backlog of user stories.
