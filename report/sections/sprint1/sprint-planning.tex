...
Our goal for sprint 1 is to continue and finish a lot of the work started prior to sprint 1.
This sprint we focus on getting an understanding of the customers needs and to pass the knowledge on to the development groups with user stories and prototypes.
