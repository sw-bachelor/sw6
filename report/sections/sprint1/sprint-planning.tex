...
\subsection{Goals and vision for the GIRAF project}
...
\subsection{Goal for the PO group}
Our goal for sprint 1 is to continue and finish the work that started prior to sprint 1.
This sprint we focus on getting an understanding of the customers needs and then to pass on the knowledge to the development groups using user stories and prototypes.
This is done to reduce the amount of errors and misunderstandings that often occur when handing out development tasks.

\noindent
This is the following goals we have for sprint 1:
\begin{table}[H]
    \centering
    \begin{tabular}{|l|l|}
    \hline
