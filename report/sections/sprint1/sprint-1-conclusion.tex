...
\begin{itemize}
    \item Group 2 were not completely done, they still needed tests for their code. They did finish their wiki assignment.
    ...
    \item Group 12 had implemented their user story. There seemed to be a problem with the backend implementation, however. As their user story was only frontend related it was considered done, and a new issue related to the backend was created instead. Their wiki assignment were also completed
