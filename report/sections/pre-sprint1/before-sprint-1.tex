...
These user stories are suggested for the first sprint because it should be easy for the developers during the start of the project, because they are not familiar with the codebase yet.
...
This is needed so the citizens know how long time their activities take.
The guardian should be able to add this timer with a specific time and connect to the activity, where after the citizen should then be the one that starts the timer.
\\\\
