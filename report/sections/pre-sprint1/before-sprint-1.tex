...
\\\\
The second user story says that the a user must be able to change the way that an activity is marked as being complete. This could for example be represented by a checkmark, by hiding the activity or by moving the activity a bit to the right on the schema for the day.
...
\\\\
The second user story concerns a feature for guardians that allows them to choose between a set of visual representations for the timers that they can add for the activites. This is needed because the citizens have different preferences when it comes to representation of the time.
\\\\
