...
The user stories are not large to be given to multiple groups.
This year it is full stack groups, and hereby a group is able to take one or more user stories for each sprint and then only work on the assigned user stories.
However the user stories that were prepared are still useful and they have been put into the backlog.
