...
\aautitlepage{%
  ...
  Prototypes, usability testing and customer contact %theme
  }{%
...
The Graphical Interface Resource for Autistic Folk (GIRAF)
 ...
 In addition to the responsibilites as a product owner, it will describe the processes used for development of the application.\\
