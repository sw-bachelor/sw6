...
\noindent The light blue boxes show the highlights of what our group has been doing during each sprint and when.

\noindent Every sprint starts with a sprint introduction where the PO group presents an introduction to the sprint.
Throughout the sprint a weekly scrum of scrums stand up is arranged, where each group can give a status update on their current progress.
