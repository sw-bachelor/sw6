...
\textit{Weekplanner\#245} it is important to give feedback when errors ocours. 
The user will not know what happend if an error ocours, and that will leave frustration and will give the user a feeling that the application is unstable.
...
\\\\
For \textit{Weekplanner\#15} it is important to show fever days to not overwhelm and confuse the citizens.
...
The citizens will not always pay attention timer, so for them to realise that the timer is up, they need to get a ding sound.
